class CartRemoveButton extends HTMLElement {
  constructor() {
    ...
    this.addEventListener('click', (event) => {
      console.log('CartRemoveButton clicked', this.dataset.index);
      event.preventDefault();
      const cartItems = this.closest('cart-items') || this.closest('cart-drawer-items');
      console.log('CartRemoveButton cartItems:', cartItems);
    ...
    if (this.tagName === 'CART-DRAWER-ITEMS') {
      return fetch(`${routes.cart_url}?section_id=cart-drawer`)
        ...
        .then((responseText) => {
          ...
          const selectors = ['cart-drawer-items', '.cart-drawer__footer', '.cart-drawer-shipping-bar', '.cart-drawer-upsell-container'];
